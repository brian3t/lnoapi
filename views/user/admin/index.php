        ...
        'header' => 'Block status',
            ...
            [
                ...
                'buttons' => [
                  ...
                  'data-confirm' => 'Are you sure you wish to send a password recovery email to this user?',
                                    'data-method' => 'POST',
                                ]
                            );
                        }
                    ...
                    'force-password-change' => function ($url, $model) use ($module) {
                        ...
                        return Html::a(
                            ...
                            [
                'title' => 'Force password change at next login',
                'data-confirm' => 'Are you sure you wish the user to change their password at next login?',
                                'data-method' => 'POST',
                            ]
                        );
                    },
