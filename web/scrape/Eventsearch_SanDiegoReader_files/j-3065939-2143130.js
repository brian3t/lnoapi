...
(function(){
    ...
    (function() {
    var p = "3065939", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_3065939||'',
    GUID:window.ftGUID_3065939||'99999999999',
    confID:window.ftConfID_3065939||'0',
    ftReturn: window.ftReturn_3065939||'',
    keyword:window.ftKeyword_3065939||'',
    ftId:window.ftId_3065939||'',
    imp:window.ftImp3065939,
    ftImpId:window.ftImp3065939 && window.ftImp3065939.impID || '',
    campaignID:'90586',
    cID:'84919',
    pID:'3065939',
    creativeID:'2143130',
    exttrack:["https://dishdigital.sp1.convertro.com/view/vt/v1/dishdigital/15/cvo.gif?cvosrc=display.gdn.crdcut&cvo_cid=90586&cvo_creative=ComparePrice_180115_YT40_300x250.zip&cvo_pid=SLGD_ACQ_MTAGAXX_COUSA_AW_DB_WTCP_CRDCU_000000XXX_2PGG_XXXX_CUSAxDVxAPPLE_XXXXX_COUSA_DWXEN_WWWXOA_PRC3_EV_EN_H5_300x250"],
    extscript:["https://cdn.doubleverify.com/dvtp_src.js?ctx=11919364&cmp=90586&sid=5056&plc=3065939&num=&adid=&advid=&adsrv=29&region=30&btreg=3065939&btadsrv=flashtalking&crt=2143130&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src"],
    clickTags: ["http://servedby.flashtalking.com/click/8/90586;3065939;2143130;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/why-we-are-better?cvosrc=display.gdn.crdcut&cvo_cid=90586&cvo_creative=ComparePrice_180115_YT40_300x250.zip&cvo_pid=SLGD_ACQ_MTAGAXX_COUSA_AW_DB_WTCP_CRDCU_000000XXX_2PGG_XXXX_CUSAxDVxAPPLE_XXXXX_COUSA_DWXEN_WWWXOA_PRC3_EV_EN_H5_300x250&utm_source=&utm_source=rtbprospecting&utm_medium=display&utm_campaign=PRC3"],
    placementDescription:'CRDCU000000XXX2PGGXXXXCUSAxDVxAPPLEXXXXXCOUSADWXENWWWXOAPRC3EVENH5300x250',
    width:300,
    height:250,
    adType:'HTML_onpage'.toLowerCase(),
    siteName:'GoogleDisplayNetwork',
    divID:'ftdiv3065939',
    phID:'ftpos3065939',
    frameID:'ftframe3065939',
    expID:'ftexpframe3065939',
    altImgID:'ftalt3065939',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/8/90586;3065939;2143130;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://www.sling.com/why-we-are-better?cvosrc=display.gdn.crdcut&cvo_cid=90586&cvo_creative=ComparePrice_180115_YT40_300x250.zip&cvo_pid=SLGD_ACQ_MTAGAXX_COUSA_AW_DB_WTCP_CRDCU_000000XXX_2PGG_XXXX_CUSAxDVxAPPLE_XXXXX_COUSA_DWXEN_WWWXOA_PRC3_EV_EN_H5_300x250&utm_source=&utm_source=rtbprospecting&utm_medium=display&utm_campaign=PRC3',
    altImg:'http://servedby.flashtalking.com/imp/8/90586;3065939;204;gif;GoogleDisplayNetwork;CRDCU000000XXX2PGGXXXXCUSAxDVxAPPLEXXXXXCOUSADWXENWWWXOAPRC3EVENH5300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/8/90586;3065939;271;pixel;GoogleDisplayNetwork;CRDCU000000XXX2PGGXXXXCUSAxDVxAPPLEXXXXXCOUSADWXENWWWXOAPRC3EVENH5300x250/?',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/306/3065939/2143130/js/j-3065939-2143130.js',
    file:'http://cdn.flashtalking.com/84919/2143130/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat8.flashtalking.com/reportV3/ft.stat?106141070-3065939;2143130;',
    adVis:true ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_3065939||'',
    segmentList:window.ftSegmentList_3065939||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp3065939 && window.ftImp3065939.jsAppend),
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m3065939')&&/^https:/.test(document.getElementById('ftscript_m3065939').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m3065939'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_3065939'],
        ['ftcfid', 'ftConfID_3065939'],
        ['fttime', 'ftTimestamp_3065939'],
        ['ftsection', 'ftSection_3065939'],
        ['ftcustom', 'ftCustom_3065939'],
        ['ft_id', 'ftId_3065939'],
        ['ftimpid','ftImp3065939', 'impID']
    ]
};
...
(function(ft){
    ...
    ft.viewableImpression = "http://servedby.flashtalking.com/imp/8/90586;3065939;202;pixel;GoogleDisplayNetwork;CRDCU000000XXX2PGGXXXXCUSAxDVxAPPLEXXXXXCOUSADWXENWWWXOAPRC3EVENH5300x250/?ft_creative=2143130&ft_configuration=";
    ft.viewableConversion = "true"==="true";
